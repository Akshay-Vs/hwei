...
const layout = ({ children }: PropsWithChildren) => {
	return (
		<main className="center flex-col gap-4 text-3xl text-secondary py-4 transition-all duration-300 w-[calc(100vw-8rem)] min-h-[calc(100vh-6rem)]  ml-24 pl-4 mt-24">
