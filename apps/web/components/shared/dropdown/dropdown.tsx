	...
	return (
		<Fragment>
			<div
				ref={dropdownRef}
				className={cn(
					'absolute top-full flex flex-col gap-2 rounded-[3.125rem] left-0 w-full h-fit z-50 p-6 bg-highlight backdrop-brightness-90 backdrop-blur-2xl shadow-lg transition-all duration-300 ease-in-out transform-gpu',
					isOpen
